...
const RoomDetails = () => {
  ...
  const saveBookings = (bookings) => {
    fetch("https://server-side-hotel-room-bookings-main.vercel.app/bookings", {
      method: "POST",
      headers: {
    ...
    <div>
      ...
      <div className="mt-10 md:grid grid-cols-6 gap-14 max-w-[1170px] mx-auto">
            ...
            <div className="flex">
              <div className="mr-5">
                <span className="people ">
                  {detailsRoom?.people?.adults} adults
                </span>
              </div>
              <div>
                <span className="children">
                  {detailsRoom.people.children} children
                </span>
              </div>
            </div>
            <div>
          ...
          <div className="mt-8">
            <div>
              <button
                className={
                  showTab == 0
                    ? `btn bg-yellow-400 border-none text-white rounded-none`
                    : `btn bg-[#f2f2f2] border-none text-[#333] rounded-none`
                }
              ...
              <button
                className={
                  showTab !== 0
                    ? `btn bg-yellow-400 border-none text-white rounded-none ml-5`
                    : `btn bg-[#f2f2f2] border-none text-[#333] rounded-none ml-5`
                }
        ...
        <div className="col-span-2 border md:p-6 relative h-[max-content] -top-10 my-5 md:my-0">
          <h2 className="bg-yellow-400 py-3 md:absolute -top-14 w-full left-0 pl-5 text-2xl text-white font-bold">
            ${detailsRoom.prize}
            <span className="text-[#353535]">/Night</span>
          </h2>
          <h4 className="text-center text-2xl checkout-header relative mb-8 text-[#424141] mt-5 md:mt-0">
            Book Room
          </h4>
          <form
            action=""
            className="checkout h-[max-content]"
            onSubmit={bookRoom}
          >
            <div className="my-4">
            ...
            <div className="flex justify-between my-8">
              <h4 className="text-sm text-[#4d4c4c]">
                Max adults : 0{detailsRoom.people.adults}
              </h4>
              <h4 className="text-sm text-[#4d4c4c]">
                Children : 0{detailsRoom.people.children}{" "}
              </h4>
            </div>
            <div className="mt-5">
              ...
              <input
                type="number"
                className="input h-3 py-4 px-2 ml-3 input-bordered w-auto"
                defaultValue={1}
                min={1}
                max={12}
                name="number"
              ...
              <small className="block mt-4">
                You can book maximum of 12 rooms
              </small>
            </div>
            <div className="text-center mt-8">
              <input
                type="submit"
                value="Book Now"
                className="btn btn-primary rounded-none w-full text-white"
              />
            </div>
          </form>
        </div>
