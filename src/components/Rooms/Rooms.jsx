    ...
    return (
        <div className='max-w-[1170px] mx-auto ' id='room'>
            <div className='flex justify-between items-center mb-3'>
                <h2 className='text-3xl font-bold text-[#333] mb-3'>Most popular rooms</h2>
                <a href="" className='underline text-yellow-600'>View All Rooms</a>
            </div>
                            ...
                            <div className="card card-compact shadow-xl rounded-none">
                                <div className='relative'>
                                    <div className='relative roomImage inline-block'>
                                        <img src={room.img} alt="Shoes" className='block w-full h-60 object-cover' />
